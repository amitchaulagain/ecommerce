							...
							<div class="tab-content" id="myTabContent">
								...
								<div class="tab-pane fade show active" id="man" role="tabpanel">
									<div class="tab-single">
										<div class="row">
<c:forEach var="showProduct" items="${listProduct}">
...
<h3><a class="bg-primary text-light" href="product-details.html"><c:out value="${showProduct.name}"/></a></h3>
<div class="product-price">
<span><c:out value="${showProduct.price}"/></span>
</div>
</div>
</div>
</div>
